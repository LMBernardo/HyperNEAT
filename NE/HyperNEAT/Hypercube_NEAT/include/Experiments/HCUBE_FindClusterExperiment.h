...
namespace HCUBE
{
    ...
    public:
        FindClusterExperiment(string _experimentName,int _threadID);
    ...
    public:
		...
		FindClusterStats(const string &tmpstring)
		{
            baitLocation.reserve(1000);
            targetLocation.reserve(1000);
            actualLocation.reserve(1000);
        ...
        virtual string toString() const
        {
            ...
            {
                oss << "Bait: " << baitLocation[a] << ' ';
                oss << "Target: " << targetLocation[a] << ' ';
                oss << "Actual: "  << actualLocation[a];
                oss << " / ";
            }
            return oss.str();
        }
